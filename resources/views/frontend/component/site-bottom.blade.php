                        ...
                        <ul class="list-post">
                            ...
                            <li class="mb-30">
                                <div class="d-flex hover-up-2 transition-normal">
                                    <div class="post-thumb post-thumb-80 d-flex mr-15 border-radius-5 img-hover-scale overflow-hidden">
                                        <a class="color-white" href="single.html">
                                            <img src="{{ asset('frontend/assets') }}/imgs/news/thumb-5.jpg" alt="">
                                        </a>
                                    </div>
                                    <div class="post-content media-body">
                            ...
                            <li class="mb-30">
                                <div class="d-flex hover-up-2 transition-normal">
                                    <div class="post-thumb post-thumb-80 d-flex mr-15 border-radius-5 img-hover-scale overflow-hidden">
                                        <a class="color-white" href="single.html">
                                            <img src="{{ asset('frontend/assets') }}/imgs/news/thumb-6.jpg" alt="">
                                        </a>
                                    </div>
                                    <div class="post-content media-body">
                        ...
                        <ul class="list-post">
                            <li class="mb-30">
                                <div class="d-flex hover-up-2 transition-normal">
                                    <div class="post-thumb post-thumb-80 d-flex mr-15 border-radius-5 img-hover-scale overflow-hidden">
                                        <a class="color-white" href="single.html">
                                            <img src="{{ asset('frontend/assets') }}/imgs/news/thumb-7.jpg" alt="">
                                        </a>
                                    </div>
                                    <div class="post-content media-body">
                            ...
                            <li class="mb-30">
                                <div class="d-flex hover-up-2 transition-normal">
                                    <div class="post-thumb post-thumb-80 d-flex mr-15 border-radius-5 img-hover-scale overflow-hidden">
                                        <a class="color-white" href="single.html">
                                            <img src="{{ asset('frontend/assets') }}/imgs/news/thumb-8.jpg" alt="">
                                        </a>
                                    </div>
                                    <div class="post-content media-body">
                            ...
                            <li class="mb-30">
                                <div class="d-flex hover-up-2 transition-normal">
                                    <div class="post-thumb post-thumb-80 d-flex mr-15 border-radius-5 img-hover-scale overflow-hidden">
                                        <a class="color-white" href="single.html">
                                            <img src="{{ asset('frontend/assets') }}/imgs/news/thumb-9.jpg" alt="">
                                        </a>
                                    </div>
                                    <div class="post-content media-body">
        ...
        <div class="sidebar-widget widget-latest-posts mb-30 mt-20 wow fadeInUp animated">
            ...
            <div class="carausel-3-columns">
                ...
                <div class="carausel-3-columns-item d-flex bg-grey has-border p-25 hover-up-2 transition-normal border-radius-5">
                    ...
                    <div class="post-content media-body">
                        <h6> <a href="category.html">{{ $category->title }}</a> </h6>
