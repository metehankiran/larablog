    ...
    <div class="featured-slider-2-items">
        <div class="slider-single">
            <div class="post-thumb position-relative">
                <div class="thumb-overlay position-relative" style="background-image: url({{ asset('frontend/assets') }}/imgs/news/news-16.jpg)">
        ...
        <div class="slider-single">
            <div class="post-thumb position-relative">
                <div class="thumb-overlay position-relative" style="background-image: url({{ asset('frontend/assets') }}/imgs/news/news-17.jpg)">
                    <div class="post-content-overlay">
                        <div class="container">
                            <div class="entry-meta meta-0 font-small mb-20">
        ...
        <div class="slider-single">
            <div class="post-thumb position-relative">
                <div class="thumb-overlay position-relative" style="background-image: url({{ asset('frontend/assets') }}/imgs/news/news-18.jpg)">
                    <div class="post-content-overlay">
                        <div class="container">
                            <div class="entry-meta meta-0 font-small mb-20">
        ...
        <div class="slider-single">
            <div class="post-thumb position-relative">
                <div class="thumb-overlay position-relative" style="background-image: url({{ asset('frontend/assets') }}/imgs/news/news-19.jpg)">
                    <div class="post-content-overlay">
                        <div class="container">
                            <div class="entry-meta meta-0 font-small mb-20">
        ...
        <div class="featured-slider-2-nav-cover">
            <div class="featured-slider-2-nav">
                <div class="slider-post-thumb mr-15 mt-20 position-relative">
                    <div class="d-flex hover-up-2 transition-normal">
                        <div class="post-thumb post-thumb-80 d-flex mr-15 border-radius-5">
                            <img class="border-radius-5" src="{{ asset('frontend/assets') }}/imgs/news/thumb-16.jpg" alt="">
                        </div>
                ...
                <div class="slider-post-thumb mr-15 mt-20 position-relative">
                    <div class="d-flex hover-up-2 transition-normal">
                        <div class="post-thumb post-thumb-80 d-flex mr-15 border-radius-5">
                            <img class="border-radius-5" src="{{ asset('frontend/assets') }}/imgs/news/thumb-17.jpg" alt="">
                        </div>
                        <div class="post-content media-body text-white">
                ...
                <div class="slider-post-thumb mr-15 mt-20 position-relative">
                    <div class="d-flex hover-up-2 transition-normal">
                        <div class="post-thumb post-thumb-80 d-flex mr-15 border-radius-5">
                            <img class="border-radius-5" src="{{ asset('frontend/assets') }}/imgs/news/thumb-18.jpg" alt="">
                        </div>
                        <div class="post-content media-body text-white">
                ...
                <div class="slider-post-thumb mr-15 mt-20 position-relative">
                    <div class="d-flex hover-up-2 transition-normal">
                        <div class="post-thumb post-thumb-80 d-flex mr-15 border-radius-5">
                            <img class="border-radius-5" src="{{ asset('frontend/assets') }}/imgs/news/thumb-19.jpg" alt="">
                        </div>
                        <div class="post-content media-body text-white">
